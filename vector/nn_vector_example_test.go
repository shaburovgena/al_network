...
func TestNNVector(t *testing.T) {
	...
	x1 := getVectorFromImage("Images/A.jpg")
	x2 := getVectorFromImage("Images/B.jpg")
	x3 := getVectorFromImage("Images/O1.jpg")

	y := getVectorFromImage("Images/O5.jpg")
